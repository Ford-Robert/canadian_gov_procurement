...
colors <- c("#377eb8", "#e41a1c", "#4daf4a", "#ff7f00", "#984ea3", "#808080")
...
buyer_colors <- c(
  "National Defence" = "#e41a1c",
  "Public Services and Procurement Canada" = "#984ea3",
  "Shared Services Canada" = "#ff7f00",
  "Public Health Agency of Canada" = "#4daf4a",
  "Fisheries and Oceans Canada" = "#377eb8",
  "Other"  = "#808080"
)
...
ggplot(data = military_spending_per_year, aes(x = year, y = total_spending)) +
  ...
  labs(x = "Year", y = "Total Spending (in Billions)") +
  theme_minimal() +
