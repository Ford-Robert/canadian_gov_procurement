...
df_table <- df %>% select(-contract, -start_date, -end_date, -link)
...
TODO Bar chart that shows how much money is awarded in small contracts (<=200k) versus how much money is awarded big contracts
