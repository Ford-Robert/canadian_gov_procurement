...
ggplot(data = grouped_df, aes(x = year, y = total_spending_billion, fill = buyer_category)) +
  ...
  theme_minimal() +
  theme(
    legend.text = element_text(size = 8), # Adjusts the size of legend text
    legend.title = element_text(size = 9), # Adjusts the size of legend title
    legend.key.size = unit(0.6, "lines") # Reduces the size of legend symbols
  )
